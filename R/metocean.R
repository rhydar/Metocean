...
plotScatter <- function(input_df,col_index = c(2,3,4),labels,...){
  ...
  t1$plot$xlab <- list(label = labels[1],cex = 0.6,scales=list(cex=0.5))
  t1$plot$ylab <- list(label = labels[2],cex = 0.6,scales=list(cex=0.5))

  t2$plot$xlab <- list(label = labels[1],cex = 0.6,scales=list(cex=0.5))
  t2$plot$ylab <- list(label = labels[3],cex = 0.6,scales=list(cex=0.5))

  t3$plot$xlab <- list(label = labels[2],cex = 0.6,scales=list(cex=0.5))
  t3$plot$ylab <- list(label = labels[3],cex = 0.6,scales=list(cex=0.5))
